 ...
 *
 * @param {number|BN|string} amount Amount of SKH tokens in WEI units to delegate.
 ...
 *
 * @param {number|string|BN} amount Amount of SKH tokens in WEI units to delegate.
 * @param {int} to Id of the validator to delegate to.
 * @param {Web3|undefined} web3Client Optional instance of an initialized Web3 client.
 * @return {{data: string, to: *, value: string}}
 */
 ...
 * @param {int} to Id of the validator the delegation belongs to.
 * @param {number|string|BN} amount Amount of SKH tokens in WEI units to be prepared for withdraw.
 * @param {Web3|undefined} web3Client Optional instance of an initialized Web3 client.
 * @return {{data: string, to: *, value: string}}
 */
 ...
 * @param {number|string|BN} amount Amount of SKH tokes in WEI format to be prepared for withdraw.
 * @param {Web3|undefined} web3Client Optional instance of an initialized Web3 client.
 * @return {{data: string, to: *, value: string}}
 */
 ...
 * contract to mint tokenized stake sSKH to the sender address representing their locked
 * stake or delegation.
 *
 ...
 * contract to redeem tokens of a tokenized stake sSKH from the sender address.
 * Please note, the tokenizer must be granted allowance on the sSKH token
 * at least for the redeemed amount of tokens.
 *
 * @param {Web3} web3Client
 * @param {string} tokenizer Address of the SFC tokenizer contract.
 * @param {int} stakerId Identifier of the validator the stake/delegation belongs to.
 * @param {number|string|BN} amount Amount of SKH tokens in WEI units to be redeemed.
 * @return {{data: string, to: *, value: string, chainId: string}}
 */
