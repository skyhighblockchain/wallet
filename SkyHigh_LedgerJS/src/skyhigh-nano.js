/**
 * This Implements SkyHigh Nano Ledger HW Wallet API
 *
 * @author Jiri Malek <jirka.malek@gmail.com>
 * @copyright (c) 2020, SkyHigh
 * @version 0.1.7
 * @licese MIT
 */
...
// SKYHIGH_CHAIN_ID represents the SkyHigh Skyhigh main chain id.
export const SKYHIGH_CHAIN_ID = 0x5c4;

// CLA specified service class used by SkyHigh Ledger application
const CLA = 0xe0;

// INS specifies instructions supported by the SkyHigh Ledger app
const INS = {
    GET_VERSION: 0x01,
    GET_PUBLIC_KEY: 0x10,
    GET_ADDRESS: 0x11,
...
// ErrorCodes exports list of errors produced by the SkyHigh Ledger app
...
// SkyHighNano implements high level SkyHigh Nano Ledger HW wallet communication
export default class SkyHighNano {
    ...
    /**
     * Construct new SkyHighNano API bridge
     *
     * @param {Transport} transport
     * @param {string} ledgerAppKey APDU proxy key of the Ledger application
     */
    constructor(transport, ledgerAppKey = "SKH") {
        // keep the transport
        ...
        // in the mean time, the SkyHigh app will restart the Ledger device to protect
    ...
    /**
     * getVersion obtains SkyHigh Nano Ledger application version
     *
    ...
    /**
     * getAddress extracts SkyHigh wallet address for the given account and address id.
     *
    ...
    /**
     * listAddresses extracts sequence of logically consequent SkyHigh wallet addresses
    ...
    /**
     * getPublicKey derives SkyHigh wallet public key for the given account and address id.
     *
     * @param {number} accountId Zero based account identifier.
     * @param {number} addressId Zero based address identifier.
     * @returns {Promise<{}>}
     ...
     *
     * Please note that the SkyHigh Ledger application is coded to provide
     * only subset of BIP32 paths with prefix "44'/60'". We don't derive
     * addresses outside of expected SkyHigh address space.
     *
     * @param {[]} bip32Path
     ...
     * Please note that the SkyHigh Ledger application is coded to provide
     * only subset of BIP32 paths with prefix "44'/60'". We don't derive
     * public keys outside of expected SkyHigh address space.
     *
     * @param bip32Path
     * @returns {Promise<{}>}
     */
