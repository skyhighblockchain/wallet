 ...
 * by an array of token addresses. If you want to use native SKH token
 * on the input, or output, use Wrapped SKH token address instead.
 *
 * @param {Web3} web3
 * @param {string} routerAddress
...
/**
 * uniswapAddLiquiditySKH creates a contract call transaction to add liquidity
 ...
 * @param {string|{BN}} amountSKHDesired
 * @param {string|{BN}} amountTokenMin
 * @param {string|{BN}} amountSKHMin
 * @param {string} to
 * @param {string|{BN}} deadline
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapAddLiquiditySKH(
    web3,
    routerAddress,
    token,
    amountTokenDesired,
    ...
    return {
        to: routerAddress,
        value: web3Utils.numberToHex(amountSKHDesired),
        data: web3.eth.abi.encodeFunctionCall({
            "constant": false,
            "inputs": [
                {
            ...
            "type": "function"
        }, [token, amountTokenDesired, amountTokenMin, amountSKHMin, to, deadline])
    };
}
...
/**
 * uniswapRemoveLiquiditySKH creates a contract call transaction to remove liquidity
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapRemoveLiquiditySKH(
    web3,
    routerAddress,
    token,
    liquidity,
    ...
    return {
        ...
        data: web3.eth.abi.encodeFunctionCall({
            ...
            "stateMutability": "nonpayable",
            "type": "function"
        }, [token, liquidity, amountTokenMin, amountSKHMin, to, deadline])
    };
}
...
/**
 * uniswapExactSKHForTokens creates a contract call transaction to swap between
 * two tokens through the given swap path specified by an array of tokens where
 * the first token is the Wrapped Native SKH one and the last token is the exit one.
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapExactSKHForTokens(
    web3,
    routerAddress,
    amountIn,
    amountOutMin,
...
/**
 * uniswapSKHForExactTokens creates a contract call transaction to swap between
 * two tokens through the given swap path specified by an array of tokens where
 * the first token is the Wrapped Native SKH and the last token is the exit one.
 * The output amount is exact and the input amount is specified by maximal allowed
 * quantity. Fuzziness of the call is towards the input. Native SKH tokens
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapSKHForExactTokens(
    web3,
    routerAddress,
    amountOut,
    amountInMax,
...
/**
 * uniswapTokensForExactSKH creates a contract call transaction to swap between
 * two tokens through the given swap path specified by an array of tokens where
 * the first token is the entry one and the last token is the Wrapped SKH. The output
 * amount is exact and the input amount is specified by maximal allowed quantity.
 * Fuzziness of the call is towards the input. Sufficient allowance is required
 * on input token to cover the max amount offered. Native SKH is returned on success.
 *
 * @param {Web3} web3
 * @param {string} routerAddress
 * @param {string|{BN}} amountOut
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapTokensForExactSKH(
    web3,
    routerAddress,
    amountOut,
    amountInMax,
...
/**
 * uniswapExactTokensForSKH creates a contract call transaction to swap between
 * two tokens through the given swap path specified by an array of tokens where
 * the first token is the entry one and the last token is the Wrapped SKH. The input
 ...
 * @returns {{data: string, to: *, value: string}}
 */
function uniswapExactTokensForSKH(
    web3,
    routerAddress,
    amountIn,
    amountOutMin,
...
export default {
    ...
    /*********** liquidity ***********/
    uniswapAddLiquidity,
    uniswapAddLiquiditySKH,
    uniswapRemoveLiquidity,
    uniswapRemoveLiquiditySKH,
    uniswapApproveShareTransfer,

    /*********** SWAP calls **********/
    uniswapExactTokensForTokens,
    uniswapExactSKHForTokens,
    uniswapTokensForExactTokens,
    uniswapSKHForExactTokens,
    uniswapTokensForExactSKH,
    uniswapExactTokensForSKH,
};
