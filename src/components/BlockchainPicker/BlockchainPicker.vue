    ...
    <ul class="blockchain-picker no-markers">
        <li>
            <label for="bc-skyhigh">
                ...
                <span>
                    <icon
                        data="@/assets/svg/chain-logos/skyhigh-active.svg"
                        width="64"
                        height="64"
                        original
                        aria-hidden="true"
                    ...
                    />
                    <icon
                        data="@/assets/svg/chain-logos/skyhigh-inactive.svg"
                        width="64"
                        height="64"
                        original
                        aria-hidden="true"
                        class="logo-inactive"
                    />
                    <span class="title">SkyHigh Blockchain</span>
                </span>
            </label>
        </li>
        <li>
