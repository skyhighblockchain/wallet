<template>
    <div class="claim-rewards-confirmation">
        ...
        >
            ...
            <div class="transaction-info">
                ...
                <div class="row no-collapse">
                    ...
                    <div class="col break-word">
                        <f-placeholder :content-loaded="!!dAccountInfo.stakerId" :replacement-num-chars="14">
                            <template v-if="dAccountInfo.stakerId">
                                <s-k-h-token-value :value="dAccountInfo.delegation.pendingRewards.amount" convert />
                            </template>
                        </f-placeholder>
                    </div>
                </div>
            ...
            >
                Staking limit reached. You can restake max {{ delegatedLimit }} SKH on validator
                {{ dAccountInfo.stakerInfo.stakerInfo.name }}, {{ dAccountInfo.stakerId }}
            </f-message>
...
export default {
    ...
    components: { SKHTokenValue, FMessage, FPlaceholder, LedgerConfirmationContent, TxConfirmation },
    ...
    methods: {
        delegatedLimitReached() {
            ...
            this.delegatedLimit = parseFloat(this.$fWallet.WEIToSKH(delegatedLimit)).toFixed(2);
