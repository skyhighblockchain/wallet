                                ...
                                <span class="address-col">
                                    ...
                                    >
                                        <template #popover-text>
                                            ...
                                            <template v-if="contact.blockchain === 'skyhigh'">
                                                <br />
                                                Warning: Use this address to receive Skyhigh SKH only. If you are
                                                receiving SKH-ERC20 you need to use a different address!
                                            </template>
                                        </template>
                                    </f-copy-button>
                                </span>
    ...
    props: {
        ...
        filterByBlockchain: {
            ...
            validator: function (_value) {
                return !_value || ['skyhigh', 'ethereum', 'binance'].indexOf(_value) !== -1;
            },
        },
    },
