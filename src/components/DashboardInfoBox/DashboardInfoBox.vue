            ...
            <div class="col balances">
                <div class="balance">
                    <h3 class="align-center-lg">
                        ...
                        <span>
                            <s-k-h-token-value :value="accountsBalance" no-currency />
                ...
                <div class="balance total-balance">
                    <h3 class="align-center-lg">
                        ...
                        <span>
                            <s-k-h-token-value :value="accountsTotalBalance" no-currency />
                            <span class="skh"> SKH</span>
                        </span>
                    </h3>
                    <div class="currency">
...
export default {
    ...
    components: { SKHTokenValue, DashboardActionsBox, FCard },
    ...
    computed: {
        ...
        accountsBalance() {
            return this.accounts.reduce((_total, _currItem) => {
                return _total + WEIToSKH(_currItem.balance);
            }, 0);
        },

        accountsTotalBalance() {
            return this.accounts.reduce((_total, _currItem) => {
                return _total + WEIToSKH(_currItem.totalBalance);
            }, 0);
        },
    },
};
