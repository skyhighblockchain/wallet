<template>
    <div class="delegation-unlock-confirmation">
        <tx-confirmation
            ...
            password-label="Please enter your wallet password to unlock your delegated SKH"
            set-tmp-pwd
        ...
        >
            <h2 class="not-visible" data-focus>Unlock SKH - Confirmation</h2>
...
export default {
    ...
    props: {
        ...
        /** Unlock maximal amount of SKH tokens */
        undelegateMax: {
            type: Boolean,
            default: false,
        },
