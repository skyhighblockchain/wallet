<template>
    <section :aria-labelledby="labelId" class="installation-info">
        ...
        <p class="">
            The SkyHigh Wallet has been created as a Progressive Web App (PWA) which is easy to launch on all platforms:
        </p>
        ...
        >
            <div class="inst-content">
                <ul class="no-markers">
                    <li>
                        <b>Step 1:</b> Open the <a href="https://wallet.skyhighblockchain.com/">SkyHigh Wallet</a> in
                        <b>Chrome</b>
                    </li>
                    <li><b>Step 2:</b> Go to <b>Settings</b> (Three dots in the top right corner)</li>
                    <li><b>Step 3:</b> Click <b>“Install SkyHigh PWA Wallet”</b></li>
                </ul>
            </div>
        </f-window>
