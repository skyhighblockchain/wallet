<template>
    <div class="receive-skh">
        <div class="align-center">
            Send your Skyhigh SKH to:
            ...
            <h3 class="address break-word" :class="addressCssClass">
                ...
                >
                    <template #popover-text>
                        ...
                        Warning: Use this address to receive Skyhigh SKH only. If you are receiving SKH-ERC20 you need to
        ...
        >
            ...
            <div class="align-center">
                <img src="img/nano-s-verify-address.png" alt="skyhigh nano device" /><br /><br />
            </div>
...
import { U2FStatus } from '../../plugins/skyhigh-nano.js';
