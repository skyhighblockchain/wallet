<template>
    <div class="stake-confirmation">
        <tx-confirmation
            ...
            password-label="Please enter your wallet password to delegate your SKH"
        ...
        >
            <h2 class="not-visible" data-focus>Delegate SKH</h2>
...
export default {
    ...
    props: {
        /** Data sent from StakeForm component. Info about transaction, validator and amount of SKH. */
        stakeData: {
            type: Object,
            default() {
                return {};
