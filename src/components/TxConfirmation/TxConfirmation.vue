<template>
    <div class="tx-confirmation">
        ...
        >
            ...
            <div class="align-center"><img src="img/nano-s-confirm-tx.png" alt="skyhigh nano device" /><br /><br /></div>
        ...
        >
            <div class="align-center">
                ...
                <div v-else-if="!$mm.isCorrectChainId()">
                    Please, select Skyhigh chain in Metamask.
                </div>
        ...
        >
            <div class="align-center">
                <div v-if="!$walletConnect.isCorrectChainId()">
                    Please, select SkyHigh Skyhigh chain.
                </div>
        ...
        async onFFormSubmit(_event) {
            ...
            if (currentAccount && this.tx && fWallet.isValidAddress(this.tx.to)) {
                ...
                if (data.gasLimit && data.gasPrice) {
                    this.$store.commit(
                        SET_TX_FEE,
                        fWallet.WEIToSKH(fWallet.getTransactionFee(data.gasPrice, data.gasLimit))
                    );
                } else {
