<template>
    <div class="unstake-confirmation">
        <tx-confirmation
            ...
            password-label="Please enter your wallet password to undelegate your SKH"
        ...
        >
            <h2 class="not-visible" data-focus>Undelegate SKH - Confirmation</h2>
            ...
            <div class="transaction-info">
                ...
                <f-message v-if="amountDiff > 0" type="warning"> {{ amountDiff }} SKH slashing applied </f-message>
            </div>
...
export default {
    ...
    components: { SKHTokenValue, FMessage, LedgerConfirmationContent, TxConfirmation },
    ...
    props: {
        ...
        /** Amount of SKH tokens to unstake */
        amount: {
            type: Number,
            default: 1,
        },
        /** Amount of SKH tokens to unlock. (hex number) */
        toUnlockAmount: {
            type: String,
            default: '',
        },
        /** Unstake maximal amount of SKH tokens */
        undelegateMax: {
            type: Boolean,
            default: false,
        },
