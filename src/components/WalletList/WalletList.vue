<template>
    <div class="wallet-list">
        <ul class="no-markers row" @click="onWalletListClick" @keyup="onWalletListKeyup">
            <li class="col-6" v-for="wallet in wallets" :key="wallet.code" :data-wallet-code="wallet.code" tabindex="0">
