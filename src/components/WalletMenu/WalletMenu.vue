<template>
    <div class="wallet-menu" :class="cssClass">
        <f-hamburger-switch v-if="!useBottomMenu" thickness="2" two-lines @hamburger-switch-on="onHamburgerSwitchOn"
        ...
        <div class="f-drawer" @click="onDrawerClick">
            ...
            <div class="footer">
                <social-media-links />
                <div class="copyright">
                    <a href="https://skyhighblockchain.com/" target="_blank" rel="noopener">©2020 SkyHigh</a>
                </div>
            </div>
        </div>
