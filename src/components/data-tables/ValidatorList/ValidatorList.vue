                    ...
                    <div v-if="column" class="row no-collapse no-vert-col-padding">
                        ...
                        <div class="col break-word">
                            <div class="inline-img validator-img">
                                ...
                                <img v-else src="img/skyhigh-logo.png" alt="skyhigh logo" class="not-fluid" />
                            </div>
                        </div>
                    </div>
                    <template v-else>
            ...
            async result(_data, _key) {
                ...
                if (_key === 'stakers') {
                    ...
                    data.forEach((_item, _idx) => {
                        // _item.total_staked = WEIToSKH(_item.stake) + WEIToSKH(_item.delegatedMe);
                        totals.selfStaked += parseFloat(numToFixed(WEIToSKH(_item.stake), 0));
                        totals.totalDelegated += parseFloat(numToFixed(WEIToSKH(_item.delegatedMe), 0));
                        totals.totalStaked += parseFloat(numToFixed(WEIToSKH(_item.totalStake), 0));
                ...
                */
                {
                    ...
                    formatter: (_value) => formatNumberByLocale(WEIToSKH(_value), 0),
                    sortFunc: sortByHex,
                    cssClass: 'align-end',
                },
                {
