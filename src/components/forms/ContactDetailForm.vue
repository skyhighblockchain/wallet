<template>
    <div class="contact-detail-form">
                        ...
                        <div class="break-word">
                            ...
                            >
                                <template #popover-text>
                                    ...
                                    Warning: Use this address to receive Skyhigh SKH only. If you are receiving SKH-ERC20
        ...
        <q-r-code-window ref="qrWindow" :address="contactData.address">
            <f-message v-show="blockchain === 'skyhigh'" type="warning" with-icon>
                Warning: Use this address to receive Skyhigh SKH only. If you are receiving SKH-ERC20 you need to use a
                different address!
            </f-message>
        </q-r-code-window>
    </div>
...
export default {
    ...
    mounted() {
        ...
        this.blockchain = this.contactData.blockchain || 'skyhigh';
    },
    ...
    methods: {
        ...
        async checkAddress(_value) {
            ...
            let address = _value;
            if (blockchain === 'skyhigh' && resolution.isSupportedDomainInNetwork(_value)) {
                try {
                    this.resolvedAddress = address = await resolution.multiChainAddr(_value, 'SKH', 'SKYHIGH');
                } catch (e) {
            ...
            if (!this.$fWallet.isValidAddress(address, blockchain)) {
                if (blockchain === 'skyhigh') {
                    this.addressErrorMsg = 'Not valid skyhigh address';
            ...
            if (
                ...
                (blockchain === 'skyhigh' && this.getAccountAndIndexByAddress(address).index !== -1)
            ) {
