            ...
            <fieldset class="">
                ...
                <div class="form-body">
                    ...
                    <div class="align-center form-buttons">
                        ...
                        <div v-if="notEnoughSKH">
                            <f-message type="warning" with-icon class="align-start">
                                Warning: Not enough available SKH for gas fees. Transfer SKH to your address to proceed.
                            </f-message>
                            <br />
                        </div>

                        <p class="max-fee" tabindex="0">Max Fee: {{ dMaxFee }} SKH</p>
                        ...
                        <template v-if="!waiting">
                            ...
                            <FButton
                                ...
                                style="max-width: 100%;"
                                :disabled="notEnoughSKH || disabledSubmit"
                            >
                                {{ sendButtonLabel }}
                            </FButton>
