            ...
            <template v-if="showPriceInfo">
                <div class="funiswap-swap__exchange-price">
                    <div class="funiswap-swap__exchange-price__row">
                        ...
                        <div class="value">
                            <f-placeholder :content-loaded="!!perPrice" replacement-text="000.0000 tUSD per fETH">
                                {{ perPrice }}
                            </f-placeholder>
                        </div>
            ...
            if (this.pairs.length > 0) {
                ...
                if (pairs.length > 0) {
                    if (params.tokena) {
                        ...
                        fromToken = TokenPairs.findTokenBySymbol(pairs[0].tokens, 'WSKH') || pairs[0].tokens[0];
                    }
                }
            }
