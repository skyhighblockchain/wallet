 ...
 * @property {boolean} skh_enabled
 * @property {boolean} listed
 * @property {boolean} listing_proposed
 * @property {boolean} skyhigh_enabled
 ...
 * @typedef {('SkyhighToBinance' | 'EthereumToBinance' | 'SkyhighToEthereum' | 'BinanceToSkyhigh' | 'BinanceToEthereum' | 'EthereumToSkyhigh')} BNBridgeDirection
 */
