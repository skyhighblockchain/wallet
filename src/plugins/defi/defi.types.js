 ...
 * @property {number} rewardCollateralRatio4 Minimal ratio between collateral and debt values in ref. denomination (tUSD) on which the account is eligible for rewards distribution.
 ...
 * @property {number} price Value of the token in ref. denomination (tUSD).
 ...
 * @property {string} value Value of the current balance of the token on the account in ref. denomination (tUSD).
 */
 ...
 * @property {string} collateralValue Current collateral value in ref. denomination (tUSD).
 ...
 * @property {string} debtValue Current debt value in ref. denomination (tUSD).
