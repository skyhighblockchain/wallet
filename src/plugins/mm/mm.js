...
const SKYHIGH_CHAIN_ID = appConfig.chainId;

/** @type {MMChain} */
export const SKYHIGH_MAINNET = {
    chainId: appConfig.mainnet.chainId,
    chainName: 'Skyhigh Mainnet',
    nativeCurrency: {
        name: 'SkyHigh',
        symbol: 'SKH',
        decimals: 18,
...
/** @type {MMChain} */
export const SKYHIGH_TESTNET = {
    chainId: appConfig.testnet.chainId,
    chainName: 'SkyHigh Testnet',
    nativeCurrency: {
        name: 'SkyHigh',
        symbol: 'SKH',
        decimals: 18,
...
export class MM {
     ...
     */
    isCorrectChainId() {
        return this._provider && this._provider.chainId === SKYHIGH_CHAIN_ID;
    }
