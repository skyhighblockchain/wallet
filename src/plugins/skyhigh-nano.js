// Basic functions for communication with skyhigh nano ledger hw, using skyhigh-ledgerjs

import SkyHighNano from 'skyhigh-ledgerjs/src/skyhigh-nano.js';
...
export class FNano {
    ...
    async getVersion() {
        ...
        if (transport) {
            ...
            const bridge = new SkyHighNano(transport);
