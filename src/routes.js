...
import DefiDepositSKH from './views/DefiDepositSKH/DefiDepositSKH.vue';
import DefiBorrowTUSD from './views/DefiBorrowTUSD/DefiBorrowTUSD.vue';
import DefiDepositSKHConfirmation from './views/DefiDepositSKHConfirmation/DefiDepositSKHConfirmation.vue';
...
import DefiBorrowTUSDConfirmation from './views/DefiBorrowTUSDConfirmation/DefiBorrowTUSDConfirmation.vue';
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        name: 'defi-borrow-tusd',
                        path: 'manage-tusd',
                        component: DefiBorrowTUSD,
                    },
                    {
                        name: 'defi-borrow-tusd-confirmation',
                        path: 'manage-tusd/confirmation',
                        component: DefiBorrowTUSDConfirmation,
                    },
                    {
                        name: 'defi-borrow-tusd-confirmation2',
                        path: 'manage-tusd/confirmation2',
                        component: DefiBorrowTUSDConfirmation,
                    },
                    {
                        name: 'defi-borrow-tusd-transaction-success-message',
                        path: 'manage-tusd/confirmation/success',
                        component: TransactionSuccessMessageView,
                    },
                    {
                        name: 'defi-borrow-tusd-transaction-success-message2',
                        path: 'manage-tusd/confirmation2/success2',
                        component: TransactionSuccessMessageView,
                    },
                    {
                        name: 'defi-borrow-tusd-transaction-reject-message',
                        path: 'manage-tusd/confirmation/reject',
                        component: TransactionRejectMessageView,
                    },
                    {
                        name: 'defi-borrow-tusd-transaction-reject-message2',
                        path: 'manage-tusd/confirmation2/reject2',
                        component: TransactionRejectMessageView,
                    },
                ],
            },
