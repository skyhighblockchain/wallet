...
export default {
    ...
    components: {
        ...
        WithdrawSKHConfirmation,
        DelegationLock,
        DelegationLockConfirmation,
        DelegationUnlockConfirmation,
        DefiMintSSKHConfirmation,
        DefiRepaySSKHConfirmation,
    },
    ...
    computed: {
        currentComponentProperties() {
            switch (this.currentComponent) {
                ...
                case 'withdraw-s-k-h-confirmation':
                case 'stake-form':
                case 'staking-info':
                case 'delegation-lock':
                case 'delegation-lock-confirmation':
                case 'defi-mint-s-s-k-h-confirmation':
                case 'defi-repay-s-s-k-h-confirmation':
                    return this._data_;
                default:
                    return null;
            }
