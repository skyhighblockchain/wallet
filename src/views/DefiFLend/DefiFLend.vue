        ...
        <div class="grid">
            <div>
                ...
                <div class="df-data-item smaller">
                    ...
                    <div class="value"><f-token-value :token="tusdToken" :value="totalDeposit" /></div>
                </div>
                <div class="df-data-item smaller">
                    <h3 class="label">Earnings</h3>
                    <div class="value">
                        -
                        <!--<f-token-value :token="tusdToken" :value="earnings" />-->
                    </div>
                </div>
            </div>
            ...
            <div class="align-end">
                ...
                <div class="df-data-item smaller">
                    ...
                    <div class="value"><f-token-value :token="tusdToken" :value="totalBorrowed" /></div>
                </div>
                <div class="df-data-item smaller">
                    <h3 class="label">Borrow limit</h3>
                    <div class="value"><f-token-value :token="tusdToken" :value="borrowLimit" /></div>
                </div>
            </div>
            <!--
