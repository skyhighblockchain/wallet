...
-->
        ...
        <div class="se-cont">
            ...
            <div class="exchange-price">
                ...
                <div class="value">
                    <f-placeholder :content-loaded="!!perPrice" replacement-text="000.00 tUSD per fETH">
                        {{ perPrice }}
                    </f-placeholder>
                </div>
...
export default {
    ...
    methods: {
        async init() {
            ...
            const wSKH = result[1].filter((_token) => _token && _token.canWrapSKH);
            ...
            const skhToken = {
                ...
                decimals: 18,
                price: wSKH[0].price,
                priceDecimals: wSKH[0].priceDecimals,
                availableBalance: account.balance,
                allowance: '0x0',
                logoUrl: 'https://cryptologos.cc/logos/skyhigh-skh-logo.svg?v=003',
            };
            this.$defi._setTokenDecimals(skhToken);

            // add SKH
            result[1].unshift(skhToken);

            this.tokens = result[1].filter((_token) => _token && (_token.symbol === 'SKH' || _token.canWrapSKH));
        ...
        onSubmit() {
            ...
            if (fromToken.canWrapSKH && toToken.symbol === 'SKH') {
                this.stepsCount = 2;
